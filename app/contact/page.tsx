...
export const metadata: Metadata = {
  title: "Liên hệ | City Memory Candles",
  description: "Thông tin liên hệ placeholder của shop nến thơm."
};
...
export default function ContactPage() {
  return (
    <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      <p className="text-sm font-semibold uppercase tracking-[0.18em] text-clay">Liên hệ</p>
